...
//#ifdef SLRING3//_WINDOWS //for ring3
#ifdef _SLRING3	

#else  /////for ring0
/*	
	__inline unsigned long rand()
	{ 
		static unsigned long dwRandIndex = 100;//(ULONG)IoGetInitialStack();
		unsigned long  dwSeed;
		dwSeed = (unsigned long)InterlockedIncrement((long*)(&dwRandIndex));
		return RtlRandom(&dwSeed);
	}*/
